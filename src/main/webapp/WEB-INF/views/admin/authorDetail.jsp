    ...
    <div class="admin_content_main">
        <div class="form_section">
            ...
            <div class="form_section_content">
                <input class="input_block" name="authorId" readonly="readonly" value="<c:out value='${authorInfo.id }'></c:out>">
        ...
        <div class="form_section">
            ...
            <div class="form_section_content">
                <input class="input_block" name="authorName" readonly value="<c:out value='${authorInfo.authorName }'></c:out>" >
            </div>
        </div>
        <div class="form_section">
            <div class="form_section_title">
            ...
            <div class="form_section_content">
                <select class="input_block" name="nationId" >
                    ...
                    <option value="01" disabled="disabled" <c:out value=" ${authorInfo.nation eq 'KOREA'? 'selected':''}"/>>국내</option>
                    <option value="02" disabled="disabled" <c:out value=" ${authorInfo.nation eq 'ETC' ? 'selected':''}"/>>국외</option>
                </select>
            </div>
        </div>
        <div class="form_section">
...
<script>
    ...
    $("#modifyBtn").on("click", function(e){
        ...
        moveForm.attr("action", "/admin/authorModify/" + idValue);
