...
<div class="admin_content_wrap">
  ...
  <div class="admin_content_main">
    ...
    <div class="form_section">
      ...
      <div class="form_section_content">
        <fmt:parseDate value="${ goodsInfo.createdDate }" pattern="yyyy-MM-dd" var="parsedDateTime" type="both" />
        <input value="<fmt:formatDate pattern="yyyy-MM-dd" value="${ parsedDateTime }" />" disabled>
      </div>
    </div>
    <div class="form_section">
      <div class="form_section_title">
      ...
      <div class="form_section_content">
        <fmt:parseDate value="${ goodsInfo.lastModifiedDate }" pattern="yyyy-MM-dd" var="parsedDateTime" type="both" />
        <input value="<fmt:formatDate pattern="yyyy-MM-dd" value="${ parsedDateTime }" />" disabled>
      </div>
    </div>
    <div class="form_section">
      ...
      <div class="form_section_content">
        <input id="authorName_input" readonly="readonly" value="${goodsInfo.author.authorName }" disabled>
...
<script>
  ...
  let targetCate2 = '';
  let targetCate3 = '${goodsInfo.category.cateCode}';

  for(let i = 0; i < cate3Array.length; i++){
    console.log(cate3Array[i].cateCode);
