...
<div class="admin_content_wrap">
    ...
    <div class="admin_content_main">
        <form action="/admin/goodsModify/${goodsInfo.id}" method="post" id="modifyForm">
            ...
            <div class="form_section">
                ...
                <div class="form_section_content">
                    <input id="authorName_input" readonly="readonly" value="${goodsInfo.author.authorName}">
                    <input id="authorId_input" name="authorId" type="hidden" value="${goodsInfo.author.id}">
            ...
            <input type="hidden" name='bookId' value="${goodsInfo.id}">
        </form>
...
<script>
    ...
    $("#cancelBtn").on("click", function(e){
        ...
        moveForm.attr("action", "/admin/goodsDetail/" + idValue)
        $("#moveForm").submit();
    });
    ...
    $("#deleteBtn").on("click", function(e){
        ...
        var idValue = ${goodsInfo.id};
        moveForm.attr("action", "/admin/goodsDelete/" + idValue);
